...
abstract final class _Fonts {
  static const urw = 'URW';
  static const montserrat = 'Montserrat';
}

/// Responsive font-size tables per TextRole (logical px).
const _sizes = {
  TextRole.displayXL: Responsive<double>(mobile: 36, tablet: 44, laptop: 56, desktop: 64, ultraWide: 72),
  TextRole.displayLG: Responsive<double>(mobile: 28, tablet: 34, laptop: 42, desktop: 48, ultraWide: 54),
  TextRole.headingLG: Responsive<double>(mobile: 22, tablet: 26, laptop: 30, desktop: 34, ultraWide: 38),
  TextRole.headingMD: Responsive<double>(mobile: 18, tablet: 20, laptop: 22, desktop: 24, ultraWide: 26),
  TextRole.headingSM: Responsive<double>(mobile: 16, tablet: 17, laptop: 18, desktop: 19, ultraWide: 20),
  TextRole.bodyLG: Responsive<double>(mobile: 16, tablet: 17, laptop: 18, desktop: 18, ultraWide: 18),
  TextRole.bodyMD: Responsive<double>(mobile: 14, tablet: 15, laptop: 16, desktop: 16, ultraWide: 16),
  TextRole.bodySM: Responsive<double>(mobile: 12, tablet: 13, laptop: 14, desktop: 14, ultraWide: 14),
  TextRole.caption: Responsive<double>(mobile: 11, tablet: 12, laptop: 12, desktop: 12, ultraWide: 12),
  TextRole.button: Responsive<double>(mobile: 14, tablet: 15, laptop: 16, desktop: 16, ultraWide: 16),
};
...
const _families = {
  TextRole.displayXL: _Fonts.urw,
  TextRole.displayLG: _Fonts.urw,
  TextRole.headingLG: _Fonts.urw,
  TextRole.headingMD: _Fonts.urw,
  TextRole.headingSM: _Fonts.urw,
...
double? _letterSpacing(TextRole role, double fontSize) {
  if (role == TextRole.displayXL || role == TextRole.displayLG) return -0.02 * fontSize;
