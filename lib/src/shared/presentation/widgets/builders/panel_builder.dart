import 'package:coursaty/src/core/constants/decorations/app_physics.dart';
...
import 'package:coursaty/src/shared/presentation/widgets/builders/row_show_all_builder.dart';
import 'package:flutter/material.dart';

typedef PanelItemBuilder<T> = Widget Function(BuildContext context, T element);

enum PanelDisplayType { list, slider, grid, none }
  ...
  Widget build(BuildContext context) {
    return ConditionalBuilder(
      ...
      onBuild: Container(
        ...
        child: Column(
          children: [
            RowShowAll(title: title, onTap: onTap, hasSpacing: true),
            Builder(
              builder: (context) {
                switch (type) {
