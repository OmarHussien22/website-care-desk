...
class ValidationConstants {
  ...
  static String validatePhoneContainNumber = _translateLabel(
    "validate_phone_is_number",
  );
  ...
  static String validatePasswordConfirm = _translateLabel(
    "validate_confirm_password",
  );
  static String validatePasswordLength = _translateLabel(
  ...
  static String validateMaxNumberCharacter = _translateLabel(
    "message_number_charachter",
  );
  static String emptyData = _translateLabel("field_required");
  static String validateFromTime = _translateLabel("validate_from_time");
  static String validateFromTimeToNow = _translateLabel(
    "validate_from_time_to_now",
  );
  static String validateToTime = _translateLabel("validate_to_time");
  static String validateToTimeToNow = _translateLabel(
    "validate_to_time_to_now",
  );
  static String validateToTimeToFromTime = _translateLabel(
    "validate_to_time_to_from_time",
  );
}
